...
const featureLinks: FeatureItem[] = [
  {
    ...
    description: "Seamlessly connect with your development pipelines",
    href: "/feature/cicd",
    icon: "/icons/feature-cicd.png",
  },
  {
    title: "Ai Pentest",
    description: "Accelerate testing with intelligent automation",
    href: "/feature/ai",
    icon: "/icons/feature-aipentest.png",
  },
  {
    title: "CLI Access",
    description: "Execute tools remotely via terminal",
    href: "/feature/cli",
    icon: "/icons/feature-cli.png",
  },
  {
    title: "Automation Tools",
    description: "Run tools instantly from the web UI",
    href: "/feature/webui",
    icon: "/icons/feature-automation.png",
  },
];
...
const resourceDocLinks: ResourceItem[] = [
  {
    title: "CLI Documents",
    description: "Guides for using tools via command line",
    href: "#",
    icon: "/icons/res-cli.png",
  },
  {
    title: "API Documents",
    description: "Accelerate testing with intelligent automation",
    href: "#",
    icon: "/icons/res-api.png",
  },
  {
    title: "Tools Documents",
    description: "Instructions for using security tools",
    href: "#",
    icon: "/icons/res-tools.png",
  },
  {
    title: "CI/CD Documents",
    description: "Setup guides for pipeline integration",
    href: "#",
    icon: "/icons/res-cicd.png",
  },
];
...
const resourceMiscLinks: ResourceItem[] = [
  { title: "About Us", href: "/about-us", icon: "/icons/about_us_icon.png" },
  {
    title: "Contact Us",
    href: "/contact-us",
    icon: "/icons/contact_us_icon.png",
  },
    ...
    >
      ...
      <span className="absolute right-1 flex items-center justify-center w-5 h-5">
        <MoonIcon
          className={cn(
            "size-3.5 transition-opacity",
            isDark ? "opacity-100 text-blue-300" : "opacity-40",
          )}
        />
      </span>
      {/* Thumb */}
